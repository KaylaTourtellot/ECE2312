...
x2, sr = librosa.load('sound2.wav')
con_left = np.concatenate([np.zeros(3), x2[0:-3]])
write("sound2.wav", sr, np.asarray(x2))
#0ms
con_left = np.concatenate([np.zeros(3), x2[0:-3]])
ar = np.asarray([x2,con_left])
...
#0ms
#1.5
con_left = np.concatenate([np.zeros(3), x2[0:-3]]) * 0.75
ar = np.asarray([x2,con_left])
write('0ms-1.5db.wav', sr, ar.T)
#3
con_left = np.concatenate([np.zeros(3), x2[0:-3]]) * 0.5
ar = np.asarray([x2,con_left])
write('0ms-3db.wav', sr, ar.T)
#6
con_left = np.concatenate([np.zeros(3), x2[0:-3]]) * 0.25
ar = np.asarray([x2,con_left])
